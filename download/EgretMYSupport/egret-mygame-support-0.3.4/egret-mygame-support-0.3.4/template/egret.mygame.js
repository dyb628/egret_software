    ...
    (function (mygame) {
        var HTML5StageText = (function (_super) {
            ...
            HTML5StageText.prototype.$show = function () {
                ...
                my.showKeyboard(info);
                my.onKeyboardConfirm(this.onKeyboardComplete);
                my.onKeyboardComplete(this.onKeyboardComplete);
                my.onKeyboardInput(this.onKeyboardInput);
            ...
            HTML5StageText.prototype.$hide = function () {
                my.offKeyboardComplete();
                my.offKeyboardConfirm();
                my.offKeyboardInput();
                my.hideKeyboard({});
...
egret.Capabilities["runtimeType" + ""] = egret.RuntimeType.MYGAME;
    ...
    (function (mygame) {
        var WebPlayer = (function (_super) {
            ...
            WebPlayer.prototype.updateScreenSize = function () {
                ...
                canvas.style[mygame.getPrefixStyleName("transformOrigin")] = "0% 0% 0px";
