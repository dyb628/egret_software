import*as Common from'../common/common.js';import{UISourceCode,UISourceCodeMetadata}from'./UISourceCode.js';export class ProjectSearchConfig{query(){}
ignoreCase(){}
isRegex(){}
queries(){}
...
export class WorkspaceImpl extends Common.ObjectWrapper.ObjectWrapper{constructor(){super();this._projects=new Map();this._hasResourceContentTrackingExtensions=false;}
