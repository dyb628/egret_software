import*as Common from'../common/common.js';export class ListModel extends Common.ObjectWrapper.ObjectWrapper{constructor(items){super();this._items=items||[];}
...
export const Events={ItemsReplaced:Symbol('ItemsReplaced'),};