...
_applySuggestion(isIntermediateSuggestion){if(this._onlyCompletion){ARIAUtils.alert(ls`${this._onlyCompletion.text}, suggestion`,this._element);this._suggestBoxDelegate.applySuggestion(this._onlyCompletion,isIntermediateSuggestion);return true;}
const suggestion=this._list.selectedItem();if(suggestion&&suggestion.text){ARIAUtils.alert(ls`${suggestion.title || suggestion.text}, suggestion`,this._element);}
...
export let Suggestion;export let Suggestions;export let AutocompleteConfig;