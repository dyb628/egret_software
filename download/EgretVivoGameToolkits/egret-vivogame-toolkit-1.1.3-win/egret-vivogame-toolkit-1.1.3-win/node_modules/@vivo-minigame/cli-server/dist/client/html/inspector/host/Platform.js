import{InspectorFrontendHostInstance}from'./InspectorFrontendHost.js';let _platform;export function platform(){if(!_platform){_platform=InspectorFrontendHostInstance.platform();}
return _platform;}
