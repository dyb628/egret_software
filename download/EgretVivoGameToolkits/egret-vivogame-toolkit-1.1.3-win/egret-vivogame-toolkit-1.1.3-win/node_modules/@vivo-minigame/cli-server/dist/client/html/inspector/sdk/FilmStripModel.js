import{Event,ObjectSnapshot,TracingModel}from'./TracingModel.js';export class FilmStripModel{constructor(tracingModel,zeroTime){this.reset(tracingModel,zeroTime);}
