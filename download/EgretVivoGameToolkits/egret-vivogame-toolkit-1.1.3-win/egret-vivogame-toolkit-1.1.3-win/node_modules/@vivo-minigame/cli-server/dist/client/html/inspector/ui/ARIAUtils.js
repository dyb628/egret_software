...
export function markAsApplication(element){element.setAttribute('role','application');}
...
export function markAsTablist(element){element.setAttribute('role','tablist');}
...
export function markAsPoliteLiveRegion(element,isAtomic){element.setAttribute('aria-live','polite');if(isAtomic){element.setAttribute('aria-atomic','true');}}
export function hasRole(element){return element.hasAttribute('role');}
export function removeRole(element){element.removeAttribute('role');}
...
export function setDisabled(element,value){element.setAttribute('aria-disabled',!!value);}
...
export function clearSelected(element){element.removeAttribute('aria-selected');}
