...
startRecording(){this._filmStripView.reset();this._filmStripView.setStatusText(Common.UIString.UIString('Recording frames...'));const tracingManagers=self.SDK.targetManager.models(SDK.TracingManager.TracingManager);if(this._tracingManager||!tracingManagers.length){return;}
