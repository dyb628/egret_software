...
this._matchedStyles.resetActiveProperties();this._hasBeenEditedIncrementally=true;var liElementList=this.treeOutline.element.querySelectorAll('li')
var alternativeIdx
...
this.property=(this._style.propertyAt(typeof alternativeIdx=='number'?alternativeIdx:this.property.index))||this.property;;if(currentNode===this.node()){this._updatePane();}
