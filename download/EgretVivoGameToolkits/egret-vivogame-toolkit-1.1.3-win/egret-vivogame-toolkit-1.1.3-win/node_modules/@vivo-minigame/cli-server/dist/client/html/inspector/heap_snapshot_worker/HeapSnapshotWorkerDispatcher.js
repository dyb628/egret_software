import*as HeapSnapshotModel from'../heap_snapshot_model/heap_snapshot_model.js';export class HeapSnapshotWorkerDispatcher{constructor(globalObject,postMessage){this._objects=[];this._global=globalObject;this._postMessage=postMessage;}
