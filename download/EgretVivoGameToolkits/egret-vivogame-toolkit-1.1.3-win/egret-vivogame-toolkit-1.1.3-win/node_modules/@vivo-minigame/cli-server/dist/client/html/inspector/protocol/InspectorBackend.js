...
return;}
if(messageObject.result&&messageObject.result.matchedCSSRules){if(messageObject.result.matchedCSSRules[0]&&messageObject.result.matchedCSSRules[0].rule&&messageObject.result.matchedCSSRules[0].rule.style){messageObject.result.matchedCSSRules[0].rule.styleSheetId=messageObject.result.matchedCSSRules[0].rule.style.styleSheetId}}
...
if(messageObject.method==='Console.messageAdded'){messageObject.method='Log.entryAdded';messageObject.params.entry=messageObject.params.message;messageObject.params.entry.args=messageObject.params.entry.parameters;messageObject.params.entry.lineNumber=messageObject.params.entry.line;messageObject.params.entry.text=messageObject.params.entry.text||'';}
...
if(['Page.removed','Page.changed'].includes(messageObject.method)){const appPanel=document.getElementById('app_data')
if(appPanel){appPanel.contentWindow.postMessage(messageObject)}
return;}
