...
setPlaceholder(placeholder,ariaPlaceholder){if(placeholder){this._element.setAttribute('data-placeholder',placeholder);ARIAUtils.setPlaceholder(this._element,ariaPlaceholder||placeholder);}else{this._element.removeAttribute('data-placeholder');ARIAUtils.setPlaceholder(this._element,null);}}
...
const DefaultAutocompletionTimeout=250;export const Events={TextChanged:Symbol('TextChanged')};