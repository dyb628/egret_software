import*as Common from'../common/common.js';import{NameValue}from'./NetworkRequest.js';export class ServerTiming{constructor(metric,value,description){this.metric=metric;this.value=value;this.description=description;}
...
static showWarning(msg){self.Common.console.warn(Common.UIString.UIString(`ServerTiming: ${msg}`));}}