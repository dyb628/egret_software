...
this._url=x;this._parsedURL=new Common.ParsedURL.ParsedURL(x);delete this._queryString;delete this._parsedQueryParameters;delete this._name;delete this._path;}
...
return null;};export let NameValue;export let WebSocketFrame;export let BlockedSetCookieWithReason;export let BlockedCookieWithReason;export let ContentData;export let EventSourceMessage;export let ExtraRequestInfo;export let ExtraResponseInfo;